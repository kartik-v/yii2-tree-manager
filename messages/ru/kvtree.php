...
return [
    ...
    'Error moving the node. Please try again later.' => 'Ошибка при перемещении элемента. Попробуйте повторить позже.',
    'Error while creating the node. Try again later.' => 'Ошибка при создании элемента. Попробуйте повторить позже',
    'Error while removing the node. Please try again later.' => 'Ошибка при удалении элемента. Попробуйте повторить позже',
    'Error while saving the node. Try again later.' => 'Ошибка при обновлении элемента. Попробуйте повторить позже',
    'ID' => 'ИД',
    'Icon' => 'Иконка',
